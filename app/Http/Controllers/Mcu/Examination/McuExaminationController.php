...
class McuExaminationController extends Controller
{
    ...
    // LAB
    public function labIndex() { $registrations = $this->getRegistrations(); return view('mcu.examinations.lab.index', compact('registrations')); }
    ...
    // RADIOLOGY
    public function radiologyIndex() { $registrations = $this->getRegistrations(); return view('mcu.examinations.radiology.index', compact('registrations')); }
    ...
    // ANAMNESIS
    public function anamnesisIndex() { $registrations = $this->getRegistrations(); return view('mcu.examinations.anamnesis.index', compact('registrations')); }
    ...
    // PHYSICAL
    public function physicalIndex() { $registrations = $this->getRegistrations(); return view('mcu.examinations.physical.index', compact('registrations')); }
    ...
    // DOCTOR
    public function doctorIndex() { $registrations = $this->getRegistrations(); return view('mcu.examinations.doctor.index', compact('registrations')); }
