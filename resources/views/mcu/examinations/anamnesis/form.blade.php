...
<div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
    <h2 class="text-2xl font-bold mb-2">Input Hasil Anamnesis</h2>
    ...
    <form action="{{ route("mcu-examinations.anamnesis.store", $mcuRegistration) }}" method="POST">
        ...
        <table class="min-w-full divide-y divide-gray-200 mb-6">
            ...
            <tbody>
                @foreach($mcuRegistration->examAnamneses as $exam)
                <tr>
                    <td class="px-6 py-4 font-medium">{{ $exam->anamnesis->name }}</td>
        ...
        <div class="flex justify-end">
            <a href="{{ route("mcu-examinations.anamnesis.index") }}" class="text-gray-600 mr-4 mt-2">Batal</a>
