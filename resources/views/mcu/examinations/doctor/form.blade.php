...
<div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
    <h2 class="text-2xl font-bold mb-2">Input Hasil Konsultasi Dokter</h2>
    ...
    <form action="{{ route("mcu-examinations.doctor.store", $mcuRegistration) }}" method="POST">
        ...
        <table class="min-w-full divide-y divide-gray-200 mb-6">
            ...
            <tbody>
                ...
                <tr>
                    <td class="px-6 py-4 font-medium">{{ $exam->medicalAction->name }}</td>
        ...
        <div class="flex justify-end">
            <a href="{{ route("mcu-examinations.doctor.index") }}" class="text-gray-600 mr-4 mt-2">Batal</a>
