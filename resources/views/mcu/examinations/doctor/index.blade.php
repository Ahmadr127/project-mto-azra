...
<div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
    <h2 class="text-2xl font-bold mb-6">Antrian Konsultasi Dokter</h2>
    <table class="min-w-full divide-y divide-gray-200">
        ...
        <tbody class="bg-white divide-y divide-gray-200">
            ...
            <tr>
                ...
                <td class="px-6 py-4">
                    <a href="{{ route("mcu-examinations.doctor.form", $reg) }}" class="bg-indigo-600 text-white px-3 py-1 rounded text-sm">Isi Hasil</a>
                </td>
            </tr>
            @endforeach
        </tbody>
