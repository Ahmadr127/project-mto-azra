        ...
        <div class="px-5 py-4 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div class="flex items-center gap-3">
                <div>
                    ...
                    <h2 class="text-xl font-bold mt-1 text-white">Antrian Pemeriksaan Fisik Clinical</h2>
                    <p class="text-xs mt-0.5 text-slate-400">Daftar pasien untuk pemeriksaan fisik organ & tanda vital.</p>
                </div>
            </div>
            ...
            @forelse($registrations as $i => $reg)
                    <tr class="hover:bg-slate-50 transition-colors">
                        ...
                        <td class="px-4 py-3">
                            <div>
                                ...
                                <span class="text-[10px] text-teal-600 font-medium flex items-center gap-1 mt-0.5">
                                    <i class="fas fa-stethoscope text-[9px]"></i> Pemeriksaan Fisik Umum
                                </span>
                            </div>
                        </td>
                        ...
                        <td class="px-4 py-3 text-right whitespace-nowrap">
                            <a href="{{ route('mcu-examinations.physical.form', $reg) }}" class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded text-xs font-bold text-white shadow-sm hover:shadow transition-all" style="background-color: #0f766e !important;">
                                <i class="fas fa-stethoscope text-[10px]"></i> Isi Hasil Fisik
                            </a>
                        </td>
                    </tr>
            @empty
