        ...
        <div class="px-5 py-4 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <h2 class="text-xl font-bold mt-1 text-white">Antrian Laboratorium Clinical</h2>
                    <p class="text-xs mt-0.5 text-slate-400">Daftar pasien aktif yang dijadwalkan untuk pengambilan dan pemeriksaan sampel lab medis.</p>
                </div>
            </div>
                ...
                <tbody class="divide-y divide-slate-100 bg-white">
                    ...
                    <tr class="hover:bg-slate-50 transition-colors">
                        ...
                        <td class="px-6 py-4">
                            <div>
                                ...
                                <span class="text-[10px] text-teal-600 font-medium flex items-center gap-1 mt-0.5">
                                    ...
                                    {{ $reg->examLabs->count() }} Parameter Lab
                                </span>
                            </div>
                        </td>
                        ...
                        <td class="px-6 py-4 text-right whitespace-nowrap">
                            <a href="{{ route('mcu-examinations.lab.form', $reg) }}" class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded text-xs font-bold text-white shadow-sm hover:shadow transition-all" style="background-color: #0f766e !important; hover:background-color: #0d9488 !important;">
