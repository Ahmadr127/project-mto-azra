...
<div class="w-full mx-auto">
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        ...
        <x-data-table :paginator="$mcu_anamneses" :columns="$columns" :showNumber="true" searchMode="manual">
            @forelse($mcu_anamneses as $i => $item)
                    <tr class="hover:bg-gray-50 transition">
                        <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-500">{{ $mcu_anamneses->firstItem() + $i }}</td>
