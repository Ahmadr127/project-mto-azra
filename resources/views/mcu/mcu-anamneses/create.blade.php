@extends('layouts.app')
@section('title', 'Tambah Master Anamnesis')

@section('content')
<div class="w-full mx-auto">
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 bg-white border-b border-gray-200">
            <h2 class="text-2xl font-bold text-gray-900 mb-6">Tambah Master Anamnesis</h2>

            <form action="{{ route('mcu-anamneses.store') }}" method="POST">
                @csrf
